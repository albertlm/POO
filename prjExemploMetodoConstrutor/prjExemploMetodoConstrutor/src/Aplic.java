    ...
    public static void main(String[] args) {
        ...
        do{
             ...
             switch(opcao){ //passagem de mensagens
                 case 1 : System.out.println("A medida da área: " + objRet.calcArea()+unidade+"²");
                          break;
                 case 2 : System.out.println("A medida do perímetro: " + objRet.calcPerimetro()+unidade);
                          break;
                 case 3 : System.out.println("A medida da diagonal: " + objRet.calcDiagonal()+unidade);
             }
        }while (opcao < 4);
    }    
}
