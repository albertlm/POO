...
public class Aplic {
    ...
    public static void main(String[] args) {
        ...
        objCliente1.setLimiteDisp(objCliente1.getLimiteCredt() - ((objItem1Ped1.getProduto().getPreco())*(objItem1Ped1.getQtdeVendida()))); 
        ...
        objCliente2.setLimiteDisp(objCliente2.getLimiteCredt() - ((objItem2Ped2.getProduto().getPreco())*(objItem2Ped2.getQtdeVendida())));        
